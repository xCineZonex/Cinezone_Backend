...
public interface BookingRepository extends JpaRepository<Booking, UUID> {
    ...
    @Query("SELECT SUM(b.montoTotal) FROM Booking b WHERE b.employee.id = :employeeId AND b.estado IN ('VALIDA', 'USADA', 'CANCELADA') AND b.metodoPago = 'EFECTIVO' AND b.fechaCompra >= :start")
